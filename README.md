...
- Excelは**結合セルに必要な高さを教えてくれない**ため、行数は計算で求めています。
  計算式（1行に入る幅・1行の高さ）は、**実際に印刷した見え方に合わせて較正**してあります。
  値は `履歴書マクロ.bas` の先頭（HABA / GYOU）にあります。

  **志望の動機の目安**（句読点を含むふつうの文章・4段落）

  | 文字数 | 〜350 | 〜400 | 〜500 | 〜550 | 〜700 | 〜850 | 〜950 |
  | --- | --- | --- | --- | --- | --- | --- | --- |
  | 文字の大きさ | **11pt** | 10pt | 9.5pt | 9pt | 8pt | 7pt | 6.5pt |
