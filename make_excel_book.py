...
MACRO_STEPS = [
    ...
    "　　C列をまるごとコピーして、②の代わりに「挿入」→「標準モジュール」の白い画面に貼り付け、",
...
def build_macro_sheet(wb) -> None:
    ...
    ws["C1"] = "【予備】★の方法で使う列（" + chr(0x201D) + " を \" に置換してから使います）"
    ws["C1"].font = note
    ...
    ws["E1"] = "↓ ◆で ThisWorkbook に貼り付ける列（この列は貼り付けても壊れません）"
    ws["E1"].font = note
