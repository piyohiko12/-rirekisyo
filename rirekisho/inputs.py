...
# 資格マスタの初期値（変換前の書き方 → 履歴書に印字する正式名称）。
# シート上でいくらでも追加・修正できる。
DEFAULT_MASTER = [
    ("英検5級", "実用英語技能検定5級"),
    ("英検4級", "実用英語技能検定4級"),
    ...
    ("乙4", "危険物取扱者乙種第4類"),
    ("危険物乙4", "危険物取扱者乙種第4類"),
    ("危険物取扱者乙種4類", "危険物取扱者乙種第4類"),
    ("電工2種", "第二種電気工事士"),
    ("第2種電気工事士", "第二種電気工事士"),
    ("電気工事士2種", "第二種電気工事士"),
    ("ガス溶接", "ガス溶接技能講習修了"),
    ("アーク溶接", "アーク溶接等特別教育修了"),
    ("アーク溶接特別教育修了", "アーク溶接等特別教育修了"),
    ("フォークリフト", "フォークリフト運転技能講習修了"),
    ("小型フォークリフト", "小型フォークリフト運転特別教育修了"),
    ("玉掛け", "玉掛け技能講習修了"),
    ("普通免許", "普通自動車第一種運転免許"),
    ...
    ("情報処理技能検定(表計算)4級", "情報処理技能検定試験 表計算4級"),
...
USAGE_LINES = [
    ...
    "3. python build_pdf.py            … 全員分のPDFを作る",
